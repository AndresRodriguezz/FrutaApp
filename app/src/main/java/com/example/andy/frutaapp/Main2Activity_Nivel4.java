...
public class Main2Activity_Nivel4 extends AppCompatActivity {
    ...
    private ImageView iv_Auno,iv_Ados,iv_vidas,signo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signo= (ImageView)findViewById(R.id.imageView3_signo);
    ...
    public void NumAleatorio () { //Metodo para el numero aleatorio
        if (score <= 29) {
            ...
            if (resultado <= 10 && resultado >= 0) {
                ...
                //recursividad es que el metodo se mande a llamar a si mismo
            }
        }else {

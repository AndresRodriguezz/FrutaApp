...
//se declaran Varibles
    int score,numAleatorio_dos, resultado, vidas =3,numAleatorio_uno;
    String nombre_Jugador,string_score,string_vidas;
//Se declara array con numeros precargados
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_nombre = (TextView) findViewById(R.id.textView_nombre);//Se hace constructor con sus datos
    ...
    public void Comparar(View view){//tipo de dato y dato, al que se le va dar al usuario
    ...
    public void NumAleatorio () { //Metodo para el numero aleatorio
        if (score <= 9) {
            ...
            if (resultado <= 10) {
                ...
                NumAleatorio(); //Se aplica recursiidad
                //Metodo recursivo  es que el metodo se mande a llamar a si mismo
            }
        }else {
            Intent intent = new Intent(this,Main2Activity_Nivel2.class);

            string_score = String.valueOf(score);// se convierte la variable score de tipo int a tipo string, es un parseo de entero a String
